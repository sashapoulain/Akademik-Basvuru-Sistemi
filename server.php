...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM uyeler WHERE uye_mail='$uye_mail' OR uye_pass='$uye_pass' LIMIT 1";
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO uyeler (uye_adi, uye_tc, uye_mail, uye_pass, uye_okul, uye_bolum, uye_tel, uye_md) 
...
if (isset($_POST['login_user'])) {
    ...
    if ($securimage->check($_POST['captcha_code']) == false) {
      ...
      if (count($errors) == 0) {
          ...
          $query = "SELECT * FROM uyeler WHERE uye_mail='$uye_mail' AND uye_pass='$uye_pass'";
