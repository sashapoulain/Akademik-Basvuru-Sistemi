                    <form action="" class="row kayit-part" method="POST" accept-charset="utf-8" enctype="multipart/form-data">    
                        <div class="col-md-6 col-md-8 mx-auto form-group">
                            ...
                            <input class="form-control" type="file" name="img6">

                            <i class="fas fa-star-of-life yıldız"></i>
                            <label class="lab">Ales Tarih Seçimi</label>
                            <select class="form-select select2 select2-md form-control" type="text" name="ayil" id="ayil">
                                <option value=""></option>
                            ...
                            <input class="form-control" type="file" name="img7" >

                            <i class="fas fa-star-of-life yıldız"></i>
                            <label class="lab">YDS Tarih Seçimi</label>
                            <select class="form-select select2 select2-md form-control" type="text" name="ydsyil" id="ydsyil">
                                <option value=""></option>
                                <option value="2015">2015</option>
                                <option value="2016">2016</option>
                                <option value="2017">2017</option>
                            ...
                            <input class="form-control" type="file" name="img8" >

                            <label class="lab">Askerlik Durum Belgesi</label>
                            <input class="form-control" type="file" name="img9" >

                            <i class="fas fa-star-of-life yıldız"></i>
                            <label class="lab">Vesikalık Fotoğraf</label>
                            <input class="form-control" type="file" name="img0" >
