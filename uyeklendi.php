...
extract($_POST);
include ("db.php");
$sql=mysqli_query($con, "SELECT * FROM uyeler WHERE uye_mail='$uye_mail'");
...
}else
{
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO uyeler(uye_adi, uye_mail, uye_pass, uye_tel, uye_md, uye_okul, uye_bolum ) VALUES ('$uye_adi', '$uye_mail',
