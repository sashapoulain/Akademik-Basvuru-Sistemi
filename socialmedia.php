  ...
  <body>
    <div id="wrap" class="sidebar-active">
        ...
        <div class="content">
            ...
            <div class="social-part p-4">
                <div class="row social">
                    <h4>Sosyal Medya'da  A.</h4>
                    <div class="sosyal-medya">

                        <div class="d-grid gap-2 d-md-block">
                            <span>Şeyma Yılmaz (DEU || YBS )</span>
                            <a href="seymayilmaz.php" class="btn me" type="button"><i class="fas fa-female"></i></a>
                        </div>
                        <div class="d-grid gap-2 d-md-block">
                            <span>Bizi Twitter' dan takip et!</span>
                            <a href="#" class="btn" type="button"><i class="fab fa-twitter"></i></a>
                        </div>
                        <div class="d-grid gap-2 d-md-block">
                            <span>Bizi Instagram' dan takip et!</span>
                            <a href="#" class="btn" type="button"><i class="fab fa-instagram"></i></a>
                        </div>
                        <div class="d-grid gap-2 d-md-block">
                            <span>Bizi Youtube' dan takip et!</span>
                            <a href="#" class="btn" type="button"><i class="fab fa-youtube-square"></i></a>
                        </div>
                        <div class="d-grid gap-2 d-md-block">
                            <span>Bizi Facebook' tan takip et!</span>
                            <a href="#" class="btn" type="button"><i class="fab fa-facebook-square"></i></a>
                        </div>
                        <div class="d-grid gap-2 d-md-block">
                            <span>Bizi LinkedIn' den takip et!</span>
                            <a href="#" class="btn" type="button"><i class="fab fa-linkedin"></i></a>
                        </div>
                        <h6><i class="fas fa-hashtag"></i>academy ile bizi etiketleyin! </h4>
                    </div>
                </div>
